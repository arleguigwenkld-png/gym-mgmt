...
// Fetch total pending clients for pagination
...
// Fetch pending clients for current page
    ...
    <div class="flex-1 sm:ml-64">
        ...
        <div class="container mx-auto max-w-6xl p-4 sm:p-8">
            <div class="bg-white p-8 rounded-xl shadow-lg">
                <h2 class="text-3xl font-bold mb-6 text-gray-800">Pending Clients</h2>
                <div class="overflow-x-auto">
                    <table class="min-w-full bg-white border border-gray-300 rounded-lg">
                        <thead>
                            <tr class="text-left bg-gray-50">
                                <th class="border px-4 py-3 text-sm font-medium text-gray-700">ID Number</th>
                                <th class="border px-4 py-3 text-sm font-medium text-gray-700">Name</th>
                                <th class="border px-4 py-3 text-sm font-medium text-gray-700">Birthday</th>
                                <th class="border px-4 py-3 text-sm font-medium text-gray-700">Contact</th>
                                <th class="border px-4 py-3 text-sm font-medium text-gray-700">Membership</th>
                                <th class="border px-4 py-3 text-sm font-medium text-gray-700">Rate</th>
                                <th class="border px-4 py-3 text-sm font-medium text-gray-700">Payment</th>
                                <th class="border px-4 py-3 text-sm font-medium text-gray-700">Status</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php while ($row = $pending_clients->fetch_assoc()) { ?>
                                <tr>
                                    <td class="border px-4 py-3 text-gray-600"><?php echo htmlspecialchars($row['id_number']); ?></td>
                                    <td class="border px-4 py-3 text-gray-600"><?php echo htmlspecialchars($row['family_name'] . ' ' . $row['given_name']); ?></td>
                                    <td class="border px-4 py-3 text-gray-600"><?php echo formatDate($row['birthday']); ?></td>
                                    <td class="border px-4 py-3 text-gray-600"><?php echo htmlspecialchars($row['contact_number']); ?></td>
                                    <td class="border px-4 py-3 text-gray-600"><?php echo htmlspecialchars($row['membership_availed']); ?></td>
                                    <td class="border px-4 py-3 text-gray-600">₱<?php echo htmlspecialchars($row['membership_rate']); ?></td>
                                    <td class="border px-4 py-3 text-gray-600"><?php echo htmlspecialchars($row['payment_mode']); ?></td>
                                    <td class="border px-4 py-3 text-gray-600"><?php echo htmlspecialchars($row['membership_status']); ?></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
